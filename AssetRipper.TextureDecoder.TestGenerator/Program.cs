...
namespace AssetRipper.TextureDecoder.TestGenerator
{
	internal static class Program
	{
		internal static readonly List<GenerationData> dataList = new()
		{
			...
			new GenerationData(typeof(ColorR64Double), 8),
			...
			new GenerationData(typeof(ColorRG128Double), 16),
			...
			new GenerationData(typeof(ColorRGB192Double), 24),
			...
			new GenerationData(typeof(ColorRGBA256Double), 32),
