...
public partial class ColorRGB48Tests
{
	[Test]
	public void CorrectSizeTest()
	{
		Assert.That(Unsafe.SizeOf<ColorRGB48>(), Is.EqualTo(6));
	}
	...
	public static ColorRGB48 MakeRandomColor()
	{
		return new()
		{
			R = 44000,
	...
	{
		ColorRGB48 original = MakeRandomColor();
		ColorRGB48 converted = original.Convert<ColorRGB48, ushort, ColorRGB48, ushort>();
		ColorRGB48 convertedBack = converted.Convert<ColorRGB48, ushort, ColorRGB48, ushort>();
	...
	{
		ColorRGB48 original = MakeRandomColor();
		ColorRGB48Signed converted = original.Convert<ColorRGB48, ushort, ColorRGB48Signed, short>();
		ColorRGB48 convertedBack = converted.Convert<ColorRGB48Signed, short, ColorRGB48, ushort>();
		Assert.That(convertedBack, Is.EqualTo(original));
	}
	...
	{
		ColorRGB48 original = MakeRandomColor();
		ColorRGBA64 converted = original.Convert<ColorRGB48, ushort, ColorRGBA64, ushort>();
		ColorRGB48 convertedBack = converted.Convert<ColorRGBA64, ushort, ColorRGB48, ushort>();
		Assert.That(convertedBack, Is.EqualTo(original));
	}
	...
	{
		ColorRGB48 original = MakeRandomColor();
		ColorRGBA64Signed converted = original.Convert<ColorRGB48, ushort, ColorRGBA64Signed, short>();
		ColorRGB48 convertedBack = converted.Convert<ColorRGBA64Signed, short, ColorRGB48, ushort>();
		Assert.That(convertedBack, Is.EqualTo(original));
	}
}
