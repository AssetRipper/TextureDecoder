...
public partial class ColorRG128DoubleTests
{
	[Test]
	public void CorrectSizeTest()
	{
		Assert.That(Unsafe.SizeOf<ColorRG128Double>(), Is.EqualTo(16));
	}
	...
	public static ColorRG128Double MakeRandomColor()
	{
		return new()
		{
			R = 0.447,
	...
	{
		ColorRG128Double original = MakeRandomColor();
		ColorRG128Double converted = original.Convert<ColorRG128Double, double, ColorRG128Double, double>();
		ColorRG128Double convertedBack = converted.Convert<ColorRG128Double, double, ColorRG128Double, double>();
	...
	{
		ColorRG128Double original = MakeRandomColor();
		ColorRGB192Double converted = original.Convert<ColorRG128Double, double, ColorRGB192Double, double>();
		ColorRG128Double convertedBack = converted.Convert<ColorRGB192Double, double, ColorRG128Double, double>();
		Assert.That(convertedBack, Is.EqualTo(original));
	}
	...
	{
		ColorRG128Double original = MakeRandomColor();
		ColorRGBA256Double converted = original.Convert<ColorRG128Double, double, ColorRGBA256Double, double>();
		ColorRG128Double convertedBack = converted.Convert<ColorRGBA256Double, double, ColorRG128Double, double>();
		Assert.That(convertedBack, Is.EqualTo(original));
	}
}
