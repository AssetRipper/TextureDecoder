...
public partial class ColorARGB16Tests
{
	...
	public static byte MakeRandomValue() => ColorRandom<ColorARGB16, byte>.MakeRandomValue();

	[Test]
	public void ConversionIsLosslessToColorARGB32()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorARGB32, byte>();
	}

	[Test]
	public void ConversionIsLosslessToColorBGRA32()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorBGRA32, byte>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_sbyte()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<sbyte>, sbyte>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_byte()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<byte>, byte>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_short()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<short>, short>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_ushort()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<ushort>, ushort>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_int()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<int>, int>();
	}
	...
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<long>, long>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_ulong()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<ulong>, ulong>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_Int128()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<Int128>, Int128>();
	}

	[Test]
	public void ConversionIsLosslessToColorRGBA_UInt128()
	{
		LosslessConversion.Assert<ColorARGB16, byte, ColorRGBA<UInt128>, UInt128>();
	}
}
